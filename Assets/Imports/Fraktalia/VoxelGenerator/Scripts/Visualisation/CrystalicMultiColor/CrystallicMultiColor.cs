...
{
	public class CrystallicMultiColor : UniformGridVisualHull
	{
		...
		CrystallicMultiColor_Calculation[] calculators;
		protected override void initializeCalculators()
		{
			...
			calculators = new CrystallicMultiColor_Calculation[NumCores];
		...
		{
			CrystallicMultiColor_Calculation usedcalculator = calculators[m];
