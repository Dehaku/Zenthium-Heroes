...
{
    public unsafe struct FUnsafeAppendBuffer : IDisposable
    {
        public void* Ptr;
        public int Size;
        public int Capacity;
        ...
        public FUnsafeAppendBuffer(int initialCapacity, int alignment, Allocator allocator)
        {
            Alignment = alignment;
            Allocator = allocator;
            Ptr = null;
        ...
        public unsafe struct Reader
        {
            ...
            public Reader(ref FUnsafeAppendBuffer buffer)
            {
                Ptr = buffer.Ptr;
                Size = buffer.Size;
                Offset = 0;
