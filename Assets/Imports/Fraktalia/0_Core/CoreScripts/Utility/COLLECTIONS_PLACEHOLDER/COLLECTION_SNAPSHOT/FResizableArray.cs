...
namespace Fraktalia.Core.Collections
{
    ...
    [PublicAPI]
    public unsafe struct FResizableArray64Byte<T> where T : struct
    {
...
#pragma warning restore 649
        ...
        {
            fixed (void* b = m_Buffer)
                return (int)FCollectionHelper.Hash(b, LengthBytes);
        }

        public override bool Equals(object other) =>
            throw new InvalidOperationException("Calling this function is a sign of inadvertent boxing");

        public bool Equals(ref FResizableArray64Byte<T> other)
        {
        ...
        public FResizableArray64Byte(T value)
        {
            m_Length = 1;
            CheckResize(1);
            fixed (void* b = m_Buffer)
        ...
        public FResizableArray64Byte(T value0, T value1)
        {
            m_Length = 2;
            CheckResize(2);
            fixed (void* b = m_Buffer)
        ...
        public FResizableArray64Byte(T value0, T value1, T value2)
        {
            m_Length = 3;
            CheckResize(3);
            fixed (void* b = m_Buffer)
        ...
        public FResizableArray64Byte(T value0, T value1, T value2, T value3)
        {
            m_Length = 4;
            CheckResize(4);
            fixed (void* b = m_Buffer)
        ...
        public FResizableArray64Byte(T value0, T value1, T value2, T value3, T value4)
        {
            m_Length = 5;
            CheckResize(5);
            fixed (void* b = m_Buffer)
