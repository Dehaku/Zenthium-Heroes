...
{
    public static class FNativeSortExtension
    {
        ...
        unsafe public static void Sort<T>(this FNativeList<T> list) where T : struct, IComparable<T>
        {
        ...
        unsafe public static void Sort<T, U>(this FNativeList<T> list, U comp) where T : struct where U : IComparer<T>
        {
        ...
        {
            IntroSort<T, U>(array, 0, length - 1, 2 * FCollectionHelper.Log2Floor(length), comp);
        }
