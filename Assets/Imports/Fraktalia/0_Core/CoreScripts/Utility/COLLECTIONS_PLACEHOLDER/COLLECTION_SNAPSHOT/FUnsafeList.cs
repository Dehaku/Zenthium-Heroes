...
namespace Fraktalia.Core.Collections
{
    ...
    /// </summary>
    public unsafe struct FUnsafeList
    {
        public void* Ptr;
        public int Length;
        public int Capacity;
        ...
        public unsafe FUnsafeList(Allocator allocator)
        {
            Allocator = allocator;
            Ptr = null;
            Length = 0;
        ...
        public unsafe FUnsafeList(int sizeOf, int alignOf, int initialCapacity, Allocator allocator, NativeArrayOptions options = NativeArrayOptions.UninitializedMemory)
        {
            Allocator = allocator;
            Ptr = null;
            Length = 0;
        ...
        /// [Unity.Collections.Allocator](https://docs.unity3d.com/ScriptReference/Unity.Collections.Allocator.html) enumeration.</param>
        /// <param name="options">Memory should be cleared on allocation or left uninitialized.</param>
        public static FUnsafeList* Create(int sizeOf, int alignOf, int initialCapacity, Allocator allocator, NativeArrayOptions options = NativeArrayOptions.UninitializedMemory)
        {
            FUnsafeList* listData = (FUnsafeList*)UnsafeUtility.Malloc(UnsafeUtility.SizeOf<FUnsafeList>(), UnsafeUtility.AlignOf<FUnsafeList>(), allocator);
            UnsafeUtility.MemClear(listData, UnsafeUtility.SizeOf<FUnsafeList>());
        ...
        /// Destroys list.
        /// </summary>
        public static void Destroy(FUnsafeList* listData)
        {
        ...
        void SetCapacity(int sizeOf, int alignOf, int capacity)
        {
            ...
            if (capacity > 0)
            {
                ...
                capacity = FCollectionHelper.CeilPow2(capacity);
            }
            ...
            Length = System.Math.Min(Length, Capacity);
        }
        ...
        {
            return FNativeArrayExtensions.IndexOf<T, T>(Ptr, Length, value);
        }
        ...
        /// If the list has reached its current capacity, internal array won't be resized, and exception will be thrown.
        /// </remarks>
        public void AddRangeNoResize<T>(FUnsafeList list) where T : struct
        {
        ...
        /// </remarks>
        /// <typeparam name="T">Source type of elements</typeparam>
        public void AddRange<T>(FUnsafeList list) where T : struct
        {
        ...
        private void RemoveRangeSwapBack(int sizeOf, int begin, int end)
        {
            ...
            if (itemsToRemove > 0)
            {
                int copyFrom = System.Math.Max(Length - itemsToRemove, end);
                void* dst = (byte*)Ptr + begin * sizeOf;
                void* src = (byte*)Ptr + copyFrom * sizeOf;
                UnsafeUtility.MemCpy(dst, src, System.Math.Min(itemsToRemove, Length - copyFrom) * sizeOf);
    ...
    /// </summary>
    [DebuggerTypeProxy(typeof(FUnsafePtrListDebugView))]
    public unsafe struct FUnsafePtrList
    {
        public readonly void** Ptr;
        public readonly int Length;
        ...
        private ref FUnsafeList ListData { get { return ref *(FUnsafeList*)UnsafeUtility.AddressOf(ref this); } }

        /// <summary>
        /// Constructs list as view into memory.
        /// </summary>
        public unsafe FUnsafePtrList(void** ptr, int length)
        {
            Ptr = ptr;
            Length = length;
            Capacity = length;
        ...
        /// <remarks>The list initially has a capacity of one. To avoid reallocating memory for the list, specify
        /// sufficient capacity up front.</remarks>
        public unsafe FUnsafePtrList(int initialCapacity, Allocator allocator, NativeArrayOptions options = NativeArrayOptions.UninitializedMemory)
        {
            Ptr = null;
            Length = 0;
            Capacity = 0;
            ...
            ListData = new FUnsafeList(sizeOf, sizeOf, initialCapacity, allocator, options);
        }

        /// <summary>
        /// </summary>
        public static FUnsafePtrList* Create(void** ptr, int length)
        {
            FUnsafePtrList* listData = (FUnsafePtrList*)UnsafeUtility.Malloc(UnsafeUtility.SizeOf<FUnsafePtrList>(), UnsafeUtility.AlignOf<FUnsafePtrList>(), Allocator.Persistent);
            *listData = new FUnsafePtrList(ptr, length);
            return listData;
        }
        ...
        /// [Unity.Collections.Allocator](https://docs.unity3d.com/ScriptReference/Unity.Collections.Allocator.html) enumeration.</param>
        /// <param name="options">Memory should be cleared on allocation or left uninitialized.</param>
        public static FUnsafePtrList* Create(int initialCapacity, Allocator allocator, NativeArrayOptions options = NativeArrayOptions.UninitializedMemory)
        {
            FUnsafePtrList* listData = (FUnsafePtrList*)UnsafeUtility.Malloc(UnsafeUtility.SizeOf<FUnsafePtrList>(), UnsafeUtility.AlignOf<FUnsafePtrList>(), allocator);
            *listData = new FUnsafePtrList(initialCapacity, allocator, options);
            return listData;
        }
        ...
        /// Destroys list.
        /// </summary>
        public static void Destroy(FUnsafePtrList* listData)
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            if (listData == null)
            {
        ...
        public void AddRange(FUnsafePtrList list)
        {
    ...
    sealed class FUnsafePtrListDebugView
    {
        private FUnsafePtrList m_UnsafePtrList;

        public FUnsafePtrListDebugView(FUnsafePtrList UnsafePtrList)
        {
