...
{
    unsafe static public class FNativeArrayExtensions
    {
        /// <summary>
        ...
        /// <param name="value">The value to locate.</param>
        /// <returns>True, if element is found.</returns>
        public static bool Contains<T, U>(this FNativeList<T> list, U value) where T : struct, IEquatable<U>
        {
        ...
        /// <param name="value">The value to locate.</param>
        /// <returns>The zero-based index of the first occurrence element if found, otherwise returns -1.</returns>
        public static int IndexOf<T, U>(this FNativeList<T> list, U value) where T : struct, IEquatable<U>
        {
